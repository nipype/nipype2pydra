"""Module to put any functions that are referred to in the "callables" section of AFNItoNIFTI.yaml"""
...
def nipype_interfaces_afni__AFNICommand___gen_filename(
    name, inputs=None, stdout=None, stderr=None, output_dir=None
):
...
# Original source at L159 of <nipype-install>/interfaces/afni/utils.py
...
# Original source at L165 of <nipype-install>/interfaces/afni/utils.py
def _gen_filename(name, inputs=None, stdout=None, stderr=None, output_dir=None):
    return os.path.abspath(nipype_interfaces_afni__AFNICommand___gen_filename(name))
