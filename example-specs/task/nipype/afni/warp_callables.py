"""Module to put any functions that are referred to in the "callables" section of Warp.yaml"""
...
# Original source at L3615 of <nipype-install>/interfaces/afni/preprocess.py
