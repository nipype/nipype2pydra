"""Module to put any functions that are referred to in the "callables" section of AutoTLRC.yaml"""
...
# Original source at L846 of <nipype-install>/interfaces/afni/preprocess.py
