"""Module to put any functions that are referred to in the "callables" section of TShift.yaml"""
...
# Original source at L3302 of <nipype-install>/interfaces/afni/preprocess.py
