...
# Original source at L2174 of <nipype-install>/interfaces/freesurfer/preprocess.py
...
# Original source at L2166 of <nipype-install>/interfaces/freesurfer/preprocess.py
def _list_outputs(inputs=None, stdout=None, stderr=None, output_dir=None):
    outputs = {}
    outfile = inputs.smoothed_file
